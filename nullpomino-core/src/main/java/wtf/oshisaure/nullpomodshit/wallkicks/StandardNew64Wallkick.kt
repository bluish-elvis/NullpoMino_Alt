...
class StandardNew64Wallkick:BaseStandardWallkick() {
	...
	companion object {
		private val kicktableL = arrayOf(arrayOf(intArrayOf(-1, 0), intArrayOf(0, 1), intArrayOf(1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(-1, 0), intArrayOf(0, 1), intArrayOf(1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(-1, 0), intArrayOf(0, 1), intArrayOf(1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(-1, 0), intArrayOf(0, 1), intArrayOf(1, 0), intArrayOf(0, -1)))
		private val kicktableR = arrayOf(arrayOf(intArrayOf(1, 0), intArrayOf(0, 1), intArrayOf(-1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(1, 0), intArrayOf(0, 1), intArrayOf(-1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(1, 0), intArrayOf(0, 1), intArrayOf(-1, 0), intArrayOf(0, -1)),
			arrayOf(intArrayOf(1, 0), intArrayOf(0, 1), intArrayOf(-1, 0), intArrayOf(0, -1)))
		private val kicktable180 = arrayOf(arrayOf(intArrayOf(0, 1), intArrayOf(0, -1)),
			arrayOf(intArrayOf(0, 1), intArrayOf(0, -1)), arrayOf(intArrayOf(0, 1), intArrayOf(0, -1)),
