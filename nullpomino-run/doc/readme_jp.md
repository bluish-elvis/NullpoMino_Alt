...
- 固定されたブロックは横一列に隙間無く並べてラインを作ることで消すことができます。積み上がった残りのブロックはその分だけ降下します。
...
* Grand Mania
 ...
 　Grand Marathonと違い、レベル500を超えても落下速度が上がり続けます。
* Grand Mastery
 　プレイ次第で最高速度が大きく上がる、上級者向けモードです。
 　Grand Maniaに似ていますが、レベルを速く上げるほど段位や落下速度がより上昇しやすくなります。
 　
...
* Grand Storm
 　落下速度が非常に速い状態からスタートする、Grand Mania上級者向けモードです。
 　レベル500を短時間で突破すると、最高速度状態でレベル999までプレイできますが、それなりの腕前が必要となります。

* Grand Lightning
 　Grand Stormよりもさらに高速でブロックが降ってくる超上級者向けモードです。
