...
class BasePvPAI(PyAI):
    ...
    def renderState(self, engine, playerID):
        ...
        r.drawScoreFont(engine, playerID, 27, 44, String.valueOf(self.lastReward),
        ...
        r.drawScoreFont(engine, playerID, 27, 45, String.valueOf(self.lastqvalue),
        ...
        r.drawScoreFont(engine, playerID, 27, 46, String.valueOf(self.lastExploreChoice),
        ...
        r.drawScoreFont(engine, playerID, 27, 47, String.valueOf(self.lastHole),
