...
NullpoMino_Alt is a Kotlin/Java Tetris-like game engine with sophisticated game modes, AI capabilities, and modular architecture. The codebase is production-grade with ~7.7K version history.
