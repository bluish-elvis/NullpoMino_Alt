...
: クリアまでが長く、やや難易度の高い標準モードですが、トップアウトしても
:レベルアップまでの上がるまでの規定ライン数はレベルごとに増加します。
- 最終レベルを以下から選択でき、規定ラインに到達するとボーナスレベルに突入します。
  ...
  - 50レベル/300ラインまで
  - 200レベル/500ラインまで
    - ボーナスレベルに到達した場合、一定時間耐えきることでゲームクリアです。
    - 200レベルのみ時間制限が有り、一定時間までに規定ラインを消してレベルアップできないとゲームオーバーです。
  - 100ライン
